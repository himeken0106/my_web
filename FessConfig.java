    ...
    */
    ...
    public static class SimpleImpl extends FessEnv.SimpleImpl implements FessConfig {
        ...
        protected java.util.Map<String, String> prepareGeneratedDefaultMap() {
            ...
            defaultMap.put(FessConfig.ELASTICSEARCH_USERNAME, System.getProperty("fess.es.username"));
            defaultMap.put(FessConfig.ELASTICSEARCH_PASSWORD, System.getProperty("fess.es.password"));
